 ...
 *
 *	CURRENT ISSUES:
 *	- The module when running will randomly encounter CLTO (SCL Low Timeout) interrupts and
 *	lock itself up. Despite my best efforts to code it to cancel the current transmission and
 *	reset itself to run again, I cannot get it to recover from this lockup.
 *	On an oscilloscope, you will see continous start conditions fired by one of the nodes,
